        ...
        <div className="container mx-auto px-4 py-12">
          ...
          <div className="prose max-w-none">
            <p className="text-lg mb-4">
              Founded in 2025, ShopNinja has grown from a small startup to a trusted online shopping destination. Our mission is to provide high-quality products at competitive prices with exceptional customer service.
            </p>
