      ...
      <div className="container mx-auto px-4">
        <div className="flex items-center justify-between">
          ...
          <Link to="/" className="flex items-center">
            <span className="text-2xl font-bold text-primary">ShopNinja</span>
          </Link>

          {/* Desktop Navigation */}
          <nav className="hidden md:flex items-center space-x-8">
            <Link to="/" className="font-medium hover:text-primary transition-colors px-3 py-2 rounded hover:bg-gray-200">
              Home
            </Link>
            <Link to="/shop" className="font-medium hover:text-primary transition-colors px-3 py-2 rounded hover:bg-gray-200">
              Shop
            </Link>
            <Link to="/categories" className="font-medium hover:text-primary transition-colors px-3 py-2 rounded hover:bg-gray-200">
              Categories
            </Link>
            <Link to="/featured" className="font-medium hover:text-primary transition-colors px-3 py-2 rounded hover:bg-gray-200  ">
              Featured 
            </Link>
          </nav>
